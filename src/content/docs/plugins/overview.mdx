...
The `quioteframework/*` packages live in their own GitHub repositories and are published to Packagist. Install each one you use with `composer require`:

```json
"require": {
  "quioteframework/db-doctrine": "^1.2.2"
}
```
</Aside>
