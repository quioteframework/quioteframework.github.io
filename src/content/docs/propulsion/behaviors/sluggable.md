...
description: Give a model a human-readable, URL-friendly slug, generated automatically before save.
---
...
:::note
The slug is unique by design. If you create a new object and the behavior calculates a slug that already exists, the string is modified to be unique:
