...
The assistant consumes `quioteframework/quiote` **v1.2.2** and registers its plugins through the dedicated `Config/plugins.php` file with `#[Plugin]`-attribute activation — the current, documented mechanism (see [Plugins and extensibility](/architecture/plugins/#registering-a-plugin)).
</Aside>
